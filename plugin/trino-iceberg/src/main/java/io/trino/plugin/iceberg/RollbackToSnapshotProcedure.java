        ...
        implements Provider<Procedure>
{
    ...
    @Inject
    public RollbackToSnapshotProcedure(IcebergMetadataFactory metadataFactory, HiveTableOperationsProvider tableOperationsProvider)
    {
    ...
    public void rollbackToSnapshot(ConnectorSession clientSession, String schema, String table, Long snapshotId)
    {
        ...
        Table icebergTable = getIcebergTable(tableOperationsProvider, metastore, clientSession, schemaTableName);
