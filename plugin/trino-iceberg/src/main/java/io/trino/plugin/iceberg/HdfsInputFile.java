        ...
        implements InputFile
{
    ...
    public SeekableInputStream newStream()
    {
        ...
        return wrap(environment.doAs(user, delegate::newStream));
    }
    ...
    private static SeekableInputStream wrap(SeekableInputStream stream)
    {
        return new HdfsInputStream(stream);
    }
