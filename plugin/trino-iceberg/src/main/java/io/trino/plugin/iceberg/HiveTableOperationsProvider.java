...
public class HiveTableOperationsProvider
{
    ...
    public TableOperations createTableOperations(
            ...
            String table)
    {
        return new HiveTableOperations(fileIoProvider.createFileIo(hdfsContext), metastore, identity, database, table, Optional.empty(), Optional.empty());
    }

    public TableOperations createTableOperations(HiveMetastore metastore, HdfsContext hdfsContext, HiveIdentity identity, String database, String table, String owner, String location)
    {
