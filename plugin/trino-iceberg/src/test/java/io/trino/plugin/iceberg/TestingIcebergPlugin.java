        ...
        implements Plugin
{
    ...
    public TestingIcebergPlugin(HiveMetastore metastore, boolean trackTableOperations)
    {
    ...
    {
        return ImmutableList.of(new TestingIcebergConnectorFactory(metastore, trackTableOperations));
    }
}
