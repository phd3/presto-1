        ...
        implements ConnectorPageSourceProvider
{
    ...
    public static class ColumnMapping
    {
                ...
                long fileModifiedTime)
        {
            ...
            for (HiveColumnHandle column : columns) {
                ...
                if (column.getColumnType() == REGULAR) {
                    ...
                    checkArgument(add(projectionsForColumn, column.getBaseHiveColumnIndex(), column.getHiveColumnProjectionInfo()), "duplicate column in columns list");
        ...
        private static boolean projectionExistsInPartitionSchema(Optional<HiveType> baseTypeCoercionFrom, HiveColumnHandle column)
        {
            ...
            List<Integer> dereferences = column.getHiveColumnProjectionInfo()
                    .map(projectedColumn -> projectedColumn.getDereferenceIndices())
