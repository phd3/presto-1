...
import static io.prestosql.plugin.hive.HiveApplyProjectionUtil.contains;
import static io.prestosql.plugin.hive.HiveApplyProjectionUtil.createProjectedColumnRepresentation;
        ...
        implements TransactionalMetadata
{
    ...
    public Optional<ProjectionApplicationResult<ConnectorTableHandle>> applyProjection(ConnectorSession session, ConnectorTableHandle handle, List<ConnectorExpression> projections, Map<String, ColumnHandle> assignments)
    {
        ...
        Map<ConnectorExpression, ProjectedColumnRepresentation> columnProjections = projectedExpressions.stream()
                .collect(toImmutableMap(Function.identity(), expression -> createProjectedColumnRepresentation(expression)));
        ...
        for (Map.Entry<ConnectorExpression, ProjectedColumnRepresentation> entry : columnProjections.entrySet()) {
            ...
            Optional<String> existingColumn = contains(assignments, projectedColumn);
