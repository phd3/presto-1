...
public class TestHiveColumnHandle
{
    ...
    public void testPartialColumn()
    {
        ...
        HiveColumnProjectionInfo partialColumnInfo = new HiveColumnProjectionInfo(ImmutableList.of(1), ImmutableList.of("b"), HiveType.HIVE_FLOAT, DOUBLE);

        HiveColumnHandle partialColumn = new HiveColumnHandle("struct_col", 88, baseHiveType, baseType, Optional.of(partialColumnInfo), REGULAR, Optional.empty());
    ...
    private void testRoundTrip(HiveColumnHandle expected)
    {
        ...
        assertEquals(actual.getHivePartialColumnInfo(), expected.getHivePartialColumnInfo());
