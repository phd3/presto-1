...
public class TestHiveColumnHandle
{
    ...
    public void testProjectedColumn()
    {
        ...
        HiveColumnProjectionInfo columnProjectionInfo = new HiveColumnProjectionInfo(ImmutableList.of(1), ImmutableList.of("b"), HiveType.HIVE_FLOAT, DOUBLE);

        HiveColumnHandle projectedColumn = new HiveColumnHandle("struct_col", 88, baseHiveType, baseType, Optional.of(columnProjectionInfo), REGULAR, Optional.empty());
