...
public class TestMetastoreHiveStatisticsProvider
{
    ...
    private static final HiveColumnHandle PARTITION_COLUMN_1 = createTopLevelHiveColumnHandle("p1", 0, HIVE_STRING, VARCHAR, PARTITION_KEY, Optional.empty());
    private static final HiveColumnHandle PARTITION_COLUMN_2 = createTopLevelHiveColumnHandle("p2", 1, HIVE_LONG, BIGINT, PARTITION_KEY, Optional.empty());
    ...
    public void testGetTableStatistics()
    {
        ...
        HiveColumnHandle columnHandle = createTopLevelHiveColumnHandle(COLUMN, 2, HIVE_LONG, BIGINT, REGULAR, Optional.empty());
