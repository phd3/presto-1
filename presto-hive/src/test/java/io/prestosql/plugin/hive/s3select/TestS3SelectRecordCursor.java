...
public class TestS3SelectRecordCursor
{
    ...
    private static final HiveColumnHandle ARTICLE_COLUMN = createTopLevelHiveColumnHandle("article", 1, HIVE_STRING, VARCHAR, REGULAR, Optional.empty());
    private static final HiveColumnHandle AUTHOR_COLUMN = createTopLevelHiveColumnHandle("author", 1, HIVE_STRING, VARCHAR, REGULAR, Optional.empty());
    private static final HiveColumnHandle DATE_ARTICLE_COLUMN = createTopLevelHiveColumnHandle("date_pub", 1, HIVE_INT, DATE, REGULAR, Optional.empty());
    private static final HiveColumnHandle QUANTITY_COLUMN = createTopLevelHiveColumnHandle("quantity", 1, HIVE_INT, INTEGER, REGULAR, Optional.empty());
