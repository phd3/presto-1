        ...
        extends AbstractTestHiveFileFormats
{
            ...
            throws Exception
    {
        ...
        TestColumn column0Primitive = new TestColumn("column0_primitive", javaLongObjectInspector, 3L, 3L);
        TestColumn column1Struct = new TestColumn(
                "column1_struct",
        ...
        TestColumn column2Primitive = new TestColumn("column2_primitive", javaLongObjectInspector, 6L, 6L);

        List<TestColumn> columnsToWrite = ImmutableList.of(column0Primitive, column1Struct, column2Primitive);
        ...
        try {
            ...
            testingPredicate = TupleDomain.withColumnDomains(ImmutableMap.of(column2Primitive, Domain.singleValue(BIGINT, 6L)));
            assertFilteredRows(testingPredicate, columnsToRead, session, split, NUM_ROWS);
            // No rows returned for a mismatched predicate
            testingPredicate = TupleDomain.withColumnDomains(ImmutableMap.of(column2Primitive, Domain.singleValue(BIGINT, 1L)));
            ...
            TestColumn projectedColumn = new TestColumn(
                    column1Struct.getBaseName(),
                    column1Struct.getBaseObjectInspector(),
            ...
            columnsToRead = ImmutableList.of(column2Primitive, projectedColumn);
            // All rows returned for a satisfying predicate
