...
public class TestIonSqlQueryBuilder
{
    ...
    public void testBuildSQL()
    {
        ...
        List<HiveColumnHandle> columns = ImmutableList.of(
                createTopLevelHiveColumnHandle("n_nationkey", 0, HIVE_INT, INTEGER, REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("n_name", 1, HIVE_STRING, VARCHAR, REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("n_regionkey", 2, HIVE_INT, INTEGER, REGULAR, Optional.empty()));
    ...
    public void testDecimalColumns()
    {
        ...
        IonSqlQueryBuilder queryBuilder = new IonSqlQueryBuilder(typeManager);
        List<HiveColumnHandle> columns = ImmutableList.of(
                createTopLevelHiveColumnHandle("quantity", 0, HiveType.valueOf("decimal(20,0)"), DecimalType.createDecimalType(), REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("extendedprice", 1, HiveType.valueOf("decimal(20,2)"), DecimalType.createDecimalType(), REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("discount", 2, HiveType.valueOf("decimal(10,2)"), DecimalType.createDecimalType(), REGULAR, Optional.empty()));
    ...
    public void testDateColumn()
    {
        IonSqlQueryBuilder queryBuilder = new IonSqlQueryBuilder(typeManager);
        List<HiveColumnHandle> columns = ImmutableList.of(
                createTopLevelHiveColumnHandle("t1", 0, HIVE_TIMESTAMP, TIMESTAMP, REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("t2", 1, HIVE_DATE, DATE, REGULAR, Optional.empty()));
        TupleDomain<HiveColumnHandle> tupleDomain = withColumnDomains(ImmutableMap.of(
    ...
    public void testNotPushDoublePredicates()
    {
        IonSqlQueryBuilder queryBuilder = new IonSqlQueryBuilder(typeManager);
        List<HiveColumnHandle> columns = ImmutableList.of(
                createTopLevelHiveColumnHandle("quantity", 0, HIVE_INT, INTEGER, REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("extendedprice", 1, HIVE_DOUBLE, DOUBLE, REGULAR, Optional.empty()),
                createTopLevelHiveColumnHandle("discount", 2, HIVE_DOUBLE, DOUBLE, REGULAR, Optional.empty()));
        TupleDomain<HiveColumnHandle> tupleDomain = withColumnDomains(
                ImmutableMap.of(
