    ...
    private class TestPreparer
    {
                ...
                throws Exception
        {
            ...
            for (int i = 0; i < testColumns.size(); i++) {
                ...
                columnsBuilder.add(createTopLevelHiveColumnHandle(testColumn.getName(), columnIndex, hiveType, type, testColumn.isPartitionKey() ? PARTITION_KEY : REGULAR, Optional.empty()));
