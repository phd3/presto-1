...
public class TestParquetPredicateUtils
{
    ...
    {
        HiveColumnHandle columnHandle = createTopLevelHiveColumnHandle("my_array", 0, HiveType.valueOf("array<int>"), new ArrayType(INTEGER), REGULAR, Optional.empty());
    ...
    public void testParquetTupleDomainStructArray()
    {
        ...
        HiveColumnHandle columnHandle = createTopLevelHiveColumnHandle("my_array_struct", 0, HiveType.valueOf("array<struct<a:int>>"), rowType, REGULAR, Optional.empty());
    ...
    {
        HiveColumnHandle columnHandle = createTopLevelHiveColumnHandle("my_primitive", 0, HiveType.valueOf("bigint"), BIGINT, REGULAR, Optional.empty());
    ...
    public void testParquetTupleDomainStruct()
    {
        ...
        HiveColumnHandle columnHandle = createTopLevelHiveColumnHandle("my_struct", 0, HiveType.valueOf("struct<a:int,b:int>"), rowType, REGULAR, Optional.empty());
    ...
    public void testParquetTupleDomainMap()
    {
        ...
        HiveColumnHandle columnHandle = createTopLevelHiveColumnHandle("my_map", 0, HiveType.valueOf("map<int,int>"), mapType, REGULAR, Optional.empty());
