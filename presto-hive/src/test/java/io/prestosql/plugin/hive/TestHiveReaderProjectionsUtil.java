...
public class TestHiveReaderProjectionsUtil
{
    ...
    public static final RowType ROWTYPE_OF_ROW_AND_PRIMITIVES = rowType(ImmutableList.of(
            new NamedTypeSignature(Optional.of(new RowFieldName("f_row")), ROWTYPE_OF_PRIMITIVES.getTypeSignature()),
            new NamedTypeSignature(Optional.of(new RowFieldName("f_bigint_0")), BIGINT.getTypeSignature())));
    ...
    static HiveColumnHandle createPartialColumnHandle(HiveColumnHandle column, List<Integer> indices)
    {
        ...
        HiveColumnProjectionInfo partialColumn = new HiveColumnProjectionInfo(indices, names, hiveType, hiveType.getType(TYPE_MANAGER));
